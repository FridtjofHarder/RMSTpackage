...
#'
compare_sample_size <- function(scale_trt, shape_trt = 1, scale_ctrl,
                                shape_ctrl = 1, parameterization = 1,
                                accrual_time = 0,
                                follow_up_time = NULL,
                                tau = NULL, sides = 1,
                                alpha = 0.025, power = 0.8, margin = 0,
                                simulation = TRUE, M = 1000, plot_curves = TRUE,
  ...
  # calculate RMSTs for both groups
  ...
  RMST_ctrl <- integrate(pweibull, shape = shape_ctrl, scale = scale_ctrl, lower = 0,
                           upper = tau, lower.tail = FALSE)$value
  Delta <- RMST_trt-RMST_ctrl # calculate RMSTD
